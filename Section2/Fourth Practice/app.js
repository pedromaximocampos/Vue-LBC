...
const app = Vue.createApp({
    ...
    data() {
        return {
            actualUserStyle: '', // Este é uma string usada para definir uma classe dinamicamente.
            show: true,          // Um boolean que será usado para alternar a visibilidade de um elemento.
            inlineStyle: ''      // Este é uma string que armazena um valor de estilo CSS para aplicação dinâmica.
        }
    },

    // Os valores computados no Vue são valores que dependem de um ou mais valores reativos,
    // sendo recalculados automaticamente quando esses valores mudam.
    computed: {
        changeVisibility() {
            // Este valor computado retorna um objeto com as propriedades sendo nomes de classes,
            // e os valores	boolean indicando se a classe deve ser aplicada ou não.
    ...
    // methods é um objeto que contém todas as funções usadas como métodos no componente.
    methods: {
        toggleButton() {
